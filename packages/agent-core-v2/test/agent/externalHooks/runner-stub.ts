 ...
 * service) with stub `IConfigService` / `IBootstrapService` and a real
 * `HostProcessService`. This keeps the matching / dedupe / stdin-payload
 * behavior under test identical to production while letting a test feed an
 * arbitrary hook list.
 */
