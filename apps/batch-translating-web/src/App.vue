<!-- apps/batch-translating-web/src/App.vue -->
...
async function handleAddProvider(input: { id: string; type: string; apiKey?: string; baseUrl?: string; defaultModel?: string; models: Array<{ model: string; maxContextSize?: number }> }): Promise<void> {
