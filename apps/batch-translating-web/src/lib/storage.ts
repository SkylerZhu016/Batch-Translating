// apps/batch-translating-web/src/lib/storage.ts
...
export const STORAGE_KEYS = {
  ...
  dayTheme: 'batch-translating.day-theme',
  nightTheme: 'batch-translating.night-theme',
  uiFont: 'batch-translating.ui-font',
