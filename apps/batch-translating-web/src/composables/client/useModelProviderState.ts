// apps/batch-translating-web/src/composables/client/useModelProviderState.ts
...
export function useModelProviderState(
  ...
  /** Replace a provider (edit models / context sizes), then reload caches. */
  async function replaceProvider(id: string, input: {
    newId?: string;
    type: string;
    apiKey?: string;
    baseUrl?: string;
