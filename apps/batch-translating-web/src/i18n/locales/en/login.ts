export default {
  ...
  errorHint: 'Please upgrade the local engine and try again',
  pollErrorTitle: 'Lost connection to the daemon',
  pollErrorHint: 'Authorization polling failed repeatedly. Check the local engine process and try again.',
} as const;
