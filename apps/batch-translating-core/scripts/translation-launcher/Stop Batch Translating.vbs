...
powerShellScript = fileSystem.BuildPath(scriptDirectory, "Stop-BatchTranslating.ps1")

If Not fileSystem.FileExists(powerShellScript) Then
    MsgBox "Stop-BatchTranslating.ps1 was not found beside this launcher.", 16, "Batch Translating"
    WScript.Quit 1
End If
