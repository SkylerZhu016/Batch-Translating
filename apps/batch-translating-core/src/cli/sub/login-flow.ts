/**
 * Shared device-code login flow used by both `batch-translating login` (top-level
 * subcommand) and `batch-translating acp --login` (the first-class ACP terminal-auth
