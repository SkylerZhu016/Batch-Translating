  ...
  parent
    ...
    .addHelpText(
      ...
      [
        ...
        '机器可读契约 / Machine-readable contracts: translation ledger help',
        '',
        '项目 / Project:',
        ...
        '成本 / Cost and budget:',
        '  cost record|record-usage --input <json|->',
        '  budget status --project <id>',
        '  budget update --project <id> --input <json|->',
        '记忆与质量 / Memory and quality:',
        '  memory record|canonical record|tm record --input <json|->',
        '  review issue|resolve --input <json|->; repair patch --input <json|->',
        '  conflict create|resolve --input <json|->; index record --input <json|->',
        '单一合并器 / Sole merger:',
        '  merge acquire|renew|release|validate --input <json|->',
        '',
